...
def main(folder_arxiv_pdfs, folder_arxiv_cits, api_key,  num_topics=5, num_queries=5, max_results=5,context=""):
    download_papers_for_query(initial_query="Language Model Agents", context=context, num_queries=num_queries, max_results=max_results)
...
if __name__ == "__main__":
    ...
    papers, sections = main(folder_arxiv_pdfs, folder_arxiv_cits, api_key, 5, 5, 5)
    print(sections)
